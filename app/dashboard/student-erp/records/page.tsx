        ...
        <div className="flex min-h-screen bg-slate-50">
            ...
            <main className="flex-1 ml-64 p-8 flex items-center justify-center">
                <div className="text-center p-12 bg-white rounded-[2rem] shadow-xl border border-slate-100 max-w-md">
                    ...
                    <h1 className="text-2xl font-black text-slate-900 mb-4 tracking-tight">Advanced Module Node</h1>
                    <p className="text-slate-500 font-medium italic">"Initializing secure data connections. This high-capacity analytic node is being syncronized for your department."</p>
