...
export const NAV_LINKS = {
    [ROLES.SUPER_ADMIN]: [
        ...
        { label: 'System Backups', href: '/dashboard/super-admin/backups' },
    ...
    [ROLES.ADMIN]: [
        ...
        { label: 'Faculty Assignments', href: '/dashboard/admin/assignments' },
        { label: 'At-Risk Interventions', href: '/dashboard/admin/at-risk' },
        { label: 'Student Grievances', href: '/dashboard/admin/grievances' },
        { label: 'Infrastructure & Labs', href: '/dashboard/admin/infrastructure' },
        { label: 'Room Registry', href: '/dashboard/admin/rooms' },
        { label: 'Financial Tracking', href: '/dashboard/admin/fees' },
        { label: 'Circulars & Notices', href: '/dashboard/admin/circulars' },
    ...
    [ROLES.STUDENT]: [
        ...
        { label: 'Academic Grades', href: '/dashboard/student/grades' },
        { label: 'Learning Roadmaps', href: '/dashboard/student/roadmaps' },
        { label: 'Class Notes', href: '/dashboard/student/notes' },
        { label: 'AI Tests & Quizzes', href: '/dashboard/student/tests' },
        { label: 'Skill Assessment', href: '/dashboard/student/skill-assessment' },
        { label: 'Live Classes', href: '/dashboard/student/live-classes' },
        { label: 'Fee Payments', href: '/dashboard/student/fees' },
...
export const LMS_NAV_LINKS = {
    ...
    [ROLES.FACULTY]: [
        { label: 'LMS Educator Hub', href: '/dashboard/faculty' },
        { label: 'AI Question Generator', href: '/dashboard/faculty/question-generator' },
        { label: 'Course Library', href: '/dashboard/faculty/courses' },
        { label: 'Assignment Logs', href: '/dashboard/faculty/assignments' },
        { label: 'Grade Center', href: '/dashboard/faculty/grades' },
    ...
    [ROLES.ADMIN]: [
        ...
        { label: 'Faculty Assignments', href: '/dashboard/admin/assignments' },
        { label: 'At-Risk Interventions', href: '/dashboard/admin/at-risk' },
        { label: 'Exam Management', href: '/dashboard/admin/exams' },
...
export const ERP_NAV_LINKS = {
    [ROLES.STUDENT]: [
        ...
        { label: 'Academic Schedule', href: '/dashboard/student-erp/schedule' },
        ...
        { label: 'AI Campus Buddy', href: '/dashboard/student-erp/ai-buddy' },
        { label: 'Campus Records', href: '/dashboard/student-erp/records' },
        { label: 'LMS Access', href: '/dashboard/student-erp/lms' },
        { label: 'Student Helpdesk', href: '/dashboard/student-erp/help' },
        { label: 'Profile Settings', href: '/dashboard/profile' },
    ],
    [ROLES.FACULTY]: [
        { label: 'Faculty ERP Node', href: '/dashboard/faculty' },
        { label: 'Smart Attendance', href: '/dashboard/faculty/attendance' },
        { label: 'Grade Center', href: '/dashboard/faculty/grades' },
        { label: 'Assignment Logs', href: '/dashboard/faculty/assignments' },
        { label: 'Student Performance', href: '/dashboard/faculty/student-performance' },
    ...
    [ROLES.ADMIN]: [
        ...
        { label: 'System Audit Logs', href: '/dashboard/admin/logs' },
    ],
    [ROLES.SUPER_ADMIN]: [
